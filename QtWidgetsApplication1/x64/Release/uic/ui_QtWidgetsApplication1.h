...
public:
    ...
    void setupUi(QMainWindow *QtWidgetsApplication1Class)
    {
        ...
        InitializeWidget->setGeometry(QRect(740, 30, 201, 141));
        gridLayoutWidget_3 = new QWidget(InitializeWidget);
        gridLayoutWidget_3->setObjectName(QString::fromUtf8("gridLayoutWidget_3"));
        gridLayoutWidget_3->setGeometry(QRect(0, 0, 195, 135));
        ...
        DeviceInitialize->addWidget(StopGrabbing_Btn, 2, 1, 1, 1);
        ...
        DeviceInitialize->addWidget(StartGrabbing_Btn, 2, 0, 1, 1);
        ...
        DeviceInitialize->addWidget(SoftTrigger_Btn, 3, 0, 1, 2);
        ...
        parameter_widget->setGeometry(QRect(740, 170, 201, 121));
